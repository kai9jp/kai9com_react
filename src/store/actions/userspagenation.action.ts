...
export const SET_USERS_CURRENTPAGE_STATE: string = "SET_USERS_CURRENTPAGE_STATE";
export const SET_USERS_NUMBEROFDISPLAYSPERPAGE_STATE: string = "SET_USERS_NUMBEROFDISPLAYSPERPAGE_STATE";

export function SetCurrentPage(CurrentPage: number): ISetCurrentPageActionType {
    return { type: SET_USERS_CURRENTPAGE_STATE, current_page: CurrentPage };
}

export function SetnumberOfDisplaysPerpage(numberOfDisplaysPerpage: number): ISetnumberOfDisplaysPerpageActionType {
    return { type: SET_USERS_NUMBEROFDISPLAYSPERPAGE_STATE, numberOfDisplaysPerpage: numberOfDisplaysPerpage };
}
